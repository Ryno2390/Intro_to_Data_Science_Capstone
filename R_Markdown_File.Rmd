...
State_Polls$rawpoll_clinton = NULL
State_Polls$rawpoll_trump = NULL
State_Polls <- unique(State_Polls)
str(State_Polls)

distances <- dist(State_Polls, method = "euclidean")
clusterStates <- hclust(distances, method = "ward")
plot(clusterStates)

clusterGroups <- cutree(clusterStates, k = 3)

# Alabama
Alabama_Cluster <- round(mean(clusterGroups[State_Polls$state == "Alabama"]))
Alabama_Cluster

# Alaska
Alaska_Cluster <- round(mean(clusterGroups[State_Polls$state == "Alaska"]))
Alaska_Cluster

# Arizona
Arizona_Cluster <- round(mean(clusterGroups[State_Polls$state == "Arizona"]))
Arizona_Cluster

# Arkansas
Arkansas_Cluster <- round(mean(clusterGroups[State_Polls$state == "Arkansas"]))
Arkansas_Cluster

# California
California_Cluster <- round(mean(clusterGroups[State_Polls$state == "California"]))
California_Cluster

# Colorado
Colorado_Cluster <- round(mean(clusterGroups[State_Polls$state == "Colorado"]))
Colorado_Cluster

# Connecticut
Connecticut_Cluster <- round(mean(clusterGroups[State_Polls$state == "Connecticut"]))
Connecticut_Cluster

# District of Columbia
District_of_Columbia_Cluster <- round(mean(clusterGroups[State_Polls$state == "District of Columbia"]))
District_of_Columbia_Cluster

# Delaware
Delaware_Cluster <- round(mean(clusterGroups[State_Polls$state == "Delaware"]))
Delaware_Cluster

# Florida
Florida_Cluster <- round(mean(clusterGroups[State_Polls$state == "Florida"]))
Florida_Cluster

# Georgia
Georgia_Cluster <- round(mean(clusterGroups[State_Polls$state == "Georgia"]))
Georgia_Cluster

# Hawaii
Hawaii_Cluster <- round(mean(clusterGroups[State_Polls$state == "Hawaii"]))
Hawaii_Cluster

# Idaho
Idaho_Cluster <- round(mean(clusterGroups[State_Polls$state == "Idaho"]))
Idaho_Cluster

# Illinois
Illinois_Cluster <- round(mean(clusterGroups[State_Polls$state == "Illinois"]))
Illinois_Cluster

# Indiana
Indiana_Cluster <- round(mean(clusterGroups[State_Polls$state == "Indiana"]))
Indiana_Cluster

# Iowa
Iowa_Cluster <- round(mean(clusterGroups[State_Polls$state == "Iowa"]))
Iowa_Cluster

# Kansas
Kansas_Cluster <- round(mean(clusterGroups[State_Polls$state == "Kansas"]))
Kansas_Cluster

# Kentucky
Kentucky_Cluster <- round(mean(clusterGroups[State_Polls$state == "Kentucky"]))
Kentucky_Cluster

# Louisiana
Louisiana_Cluster <- round(mean(clusterGroups[State_Polls$state == "Louisiana"]))
Louisiana_Cluster

# Maine
Maine_Cluster <- round(mean(clusterGroups[State_Polls$state == "Maine"]))
Maine_Cluster

# Maryland
Maryland_Cluster <- round(mean(clusterGroups[State_Polls$state == "Maryland"]))
Maryland_Cluster

# Massachusetts
Massachusetts_Cluster <- round(mean(clusterGroups[State_Polls$state == "Massachusetts"]))
Massachusetts_Cluster

# Michigan
Michigan_Cluster <- round(mean(clusterGroups[State_Polls$state == "Michigan"]))
Michigan_Cluster

# Minnesota
Minnesota_Cluster <- round(mean(clusterGroups[State_Polls$state == "Minnesota"]))
Minnesota_Cluster

# Mississippi
Mississippi_Cluster <- round(mean(clusterGroups[State_Polls$state == "Mississippi"]))
Mississippi_Cluster

# Missouri
Missouri_Cluster <- round(mean(clusterGroups[State_Polls$state == "Missouri"]))
Missouri_Cluster

# Montana
Montana_Cluster <- round(mean(clusterGroups[State_Polls$state == "Montana"]))
Montana_Cluster

# Nebraska
Nebraska_Cluster <- round(mean(clusterGroups[State_Polls$state == "Nebraska"]))
Nebraska_Cluster

# Nevada
Nevada_Cluster <- round(mean(clusterGroups[State_Polls$state == "Nevada"]))
Nevada_Cluster

# New Hampshire
New_Hampshire_Cluster <- round(mean(clusterGroups[State_Polls$state == "New Hampshire"]))
New_Hampshire_Cluster

# New Jersey
New_Jersey_Cluster <- round(mean(clusterGroups[State_Polls$state == "New Jersey"]))
New_Jersey_Cluster

# New Mexico
New_Mexico_Cluster <- round(mean(clusterGroups[State_Polls$state == "New Mexico"]))
New_Mexico_Cluster

# New York
New_York_Cluster <- round(mean(clusterGroups[State_Polls$state == "New York"]))
New_York_Cluster

# North Carolina
North_Carolina_Cluster <- round(mean(clusterGroups[State_Polls$state == "North Carolina"]))
North_Carolina_Cluster

# North Dakota
North_Dakota_Cluster <- round(mean(clusterGroups[State_Polls$state == "North Dakota"]))
North_Dakota_Cluster

# Ohio
Ohio_Cluster <- round(mean(clusterGroups[State_Polls$state == "Ohio"]))
Ohio_Cluster

# Oklahoma
Oklahoma_Cluster <- round(mean(clusterGroups[State_Polls$state == "Oklahoma"]))
Oklahoma_Cluster

# Oregon
Oregon_Cluster <- round(mean(clusterGroups[State_Polls$state == "Oregon"]))
Oregon_Cluster

# Pennsylvania
Pennsylvania_Cluster <- round(mean(clusterGroups[State_Polls$state == "Pennsylvania"]))
Pennsylvania_Cluster

# Rhode Island
Rhode_Island_Cluster <- round(mean(clusterGroups[State_Polls$state == "Rhode Island"]))
Rhode_Island_Cluster

# South Carolina
South_Carolina_Cluster <- round(mean(clusterGroups[State_Polls$state == "South Carolina"]))
South_Carolina_Cluster

# South Dakota
South_Dakota_Cluster <- round(mean(clusterGroups[State_Polls$state == "South Dakota"]))
South_Dakota_Cluster

# Tennessee
Tennessee_Cluster <- round(mean(clusterGroups[State_Polls$state == "Tennessee"]))
Tennessee_Cluster

# Texas
Texas_Cluster <- round(mean(clusterGroups[State_Polls$state == "Texas"]))
Texas_Cluster

# Utah
Utah_Cluster <- round(mean(clusterGroups[State_Polls$state == "Utah"]))
Utah_Cluster

# Vermont
Vermont_Cluster <- round(mean(clusterGroups[State_Polls$state == "Vermont"]))
Vermont_Cluster

# Virginia
Virginia_Cluster <- round(mean(clusterGroups[State_Polls$state == "Virginia"]))
Virginia_Cluster

# Washington
Washington_Cluster <- round(mean(clusterGroups[State_Polls$state == "Washington"]))
Washington_Cluster

# West Virginia
West_Virginia_Cluster <- round(mean(clusterGroups[State_Polls$state == "West Virginia"]))
West_Virginia_Cluster

# Wisconsin
Wisconsin_Cluster <- round(mean(clusterGroups[State_Polls$state == "Wisconsin"]))
Wisconsin_Cluster

# Wyoming
Wyoming_Cluster <- round(mean(clusterGroups[State_Polls$state == "Wyoming"]))
Wyoming_Cluster
