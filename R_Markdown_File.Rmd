...
This type of information is valuable to campaigns because campaigns face budget constraints. Though the Clinton campaign spent a large amount of money during the 2016 campaign, the campaign's budget was not infinite: all campaigns have to make strategic decisions about how to optimally allocate the limited resources at their disposal.
...
My approach will be to create a machine learning program that will be able to incorporate new, raw polling data and to categroize states according to status (i.e. Clinton supporting, Trump Supporting, or Swing) using a k-means clustering method. Then, using a modified version of this model I will also categorize states into a simple binary of Clinton and Trump states, updating my prediction of electoral vote totals for each candidate. The candidate who reaches 270 electoral votes is deemed the winner.
