...
State_Polls_Swing <- unique(State_Polls)
...
# California
California_Cluster_Swing <- round(mean(clusterGroups_Swing[State_Polls$state == "California"]))
...
If we then order this list from the greatest number of electoral votes to the least, we get the following "hit list" of swing states:
...
This "hit list", represents the states that, according to the model, Clinton should focus on in order to reach 270 electoral votes.
...
# California
California_Cluster_Final <- round(mean(clusterGroups_Final[State_Polls$state == "California"]))
