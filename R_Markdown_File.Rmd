...
For example, if Clinton were to lose all of her "at risk" states but gained all of the largest swing states, she would net gain 22 electoral votes, bringing her total up to 295 from 273. Perhaps this would change the perceptions of Congress of her political capital - shifting the narrative from barely eeking our a win to having won comfortably.

However, if we take into account the hypothetical role of this analysis is simply to get our candidate elected, then the calculus of our recommendation changes. If the goal is purely to get the requisite number of electoral votes with the highest probability of success, then the only strategy that does this is the conservative strategy.
